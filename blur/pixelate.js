...
(function (window, undefined) {
    ...
    function ClosePixelation(img, options) {
        this.img = img
        // creat canvas
        var canvas = this.canvas = document.getElementById('b')
    ...
    ClosePixelation.prototype.render = function (options) {
        ...
        // set size
        var w = this.width = this.canvas.width
        var h = this.height = this.canvas.height
        ...
        for (row = 0; row < rows; row++) {
            ...
            for (col = 0; col < cols; col++) {
                ...
                switch (opts.shape) {
                    ...
                    case 'rect':
                        // square
                        ctx.fillRect(x - halfSize, y - halfSizeY, size, sizeY)
                        break;
                    default:
                        // square
